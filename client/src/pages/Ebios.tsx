    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">EBIOS RM</h1>
            <p className="text-muted-foreground mt-2">
              Module de gestion des EBIOS RM
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>EBIOS RM</CardTitle>
            <CardDescription>
              Gestion complète du module EBIOS RM
            </CardDescription>
          </CardHeader>
          <CardContent>
